...
<div class="contenedor p-5">
	  ...
	  <div class="col-xs-12 text-right">
		  <a href="AgregarNuevo.php" class="btn btn-default" ><span class="glyphicon glyphicon-plus"></span> Agregar </a>
	  </div>

	<div class="row p-3">
	  <div class="col text-center">
		<h1>Antes y Despues</h1> 
		<p>Servicio de Salon</p>
	  </div>
	...
	if($stmt->rowCount() > 0)
	{
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<div class="col-md-12" style="padding: 30px;">
				...
				<td>
					<a class="btn btn-warning btn-sm" href="EditarImagen.php?edit_id=<?php echo $row['Imagen_ID']; ?>">Editar</a>
