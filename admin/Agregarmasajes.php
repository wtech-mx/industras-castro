...
<?php
	...
	if(isset($_POST['btnsave']))
	{
		...
		if(!isset($errMSG)){
			$stmt = $DB_con->prepare('INSERT INTO masajes(Imagen_Marca,Imagen_Tipo,Imagen_Img,Imagen_Img2) VALUES(:uname, :ujob, :upic, :upic2)');
			...
			if($stmt->execute())
			{
				...
				header("refresh:1;masajes-ab.php"); // redirects image view page after 5 seconds.
			}
			else
			{
