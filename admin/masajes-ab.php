...
if(isset($_GET['delete_id'])){
	...
	header("Location: masajes-ab.php");
}
...
<div class="contenedor p-5">
	  ...
	  <div class="col-xs-12 text-right">
		  <a href="Agregarmasajes.php" class="btn btn-default" ><span class="glyphicon glyphicon-plus"></span> Agregar </a>
	  </div>
	...
	if($stmt->rowCount() > 0)
	{
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<div class="col-md-12" style="padding: 30px;">
				...
				<td>
					<a class="btn btn-warning btn-sm" href="Editarmasajes-bf.php?edit_id=<?php echo $row['Imagen_ID']; ?>">Editar</a>
